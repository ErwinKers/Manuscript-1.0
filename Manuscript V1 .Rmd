...
Necessary to run in order due to dependencies on libraries in early chunks of code
...
```{r echo=FALSE,results='hide',fig.keep='all', fig.height = 4, fig.width = 8, fig.align = "center"}
water <- read.csv2("C:/Users/Erwin/OneDrive/Manuscript Erwin Kers/R script + data/Manuscript-1.0/Data/WATER sensor.csv")
...
library(tidyverse)
library(ggbreak)
nutrient <- read_excel("C:/Users/Erwin/OneDrive/Manuscript Erwin Kers/R script + data/Manuscript-1.0/Data/nutrient data.xlsx")
...
library(tidyverse)
library(cowplot)
Chla <- read_excel("C:/Users/Erwin/OneDrive/Manuscript Erwin Kers/R script + data/Manuscript-1.0/Data/Chl-a for R.xlsx")
...
phy <- read_excel("C:/Users/Erwin/OneDrive/Manuscript Erwin Kers/R script + data/Manuscript-1.0/Data/Phytoplankton community.xlsx")
library(ggplot2)
library(tidyverse)
library(forcats)
library(ggthemes)
...
### Biomass zooplankton
Biom <-read.csv2("C:/Users/Erwin/OneDrive/Manuscript Erwin Kers/R script + data/Manuscript-1.0/Data/Zooplankton Biomass.csv")
...
```{r echo=FALSE,results='hide',fig.keep='all', fig.height = 4, fig.width = 8, fig.align = "center"}
Zoopcomp <- read.csv2("C:/Users/Erwin/OneDrive/Manuscript Erwin Kers/R script + data/Manuscript-1.0/Data/Zooplankton ID complete.csv")
